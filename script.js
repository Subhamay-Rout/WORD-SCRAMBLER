  ...
  timer = setInterval(() => {
    if (maxTime > 0) {
      ...
      document.querySelector(
        ".container .time-box span"
      ).innerHTML = `Time: ${maxTime}s`;
      if (maxTime < 10) {
        document.querySelector(".container .time-box").style.background =
          "#ffdde0";
        document.querySelector(".container .time-box").style.color = "#d32f2f";
        document.querySelector(".container .time-box").style.border =
          "1px solid #d32f2f";
      } else {
        document.querySelector(".container .time-box").style.background =
          "#e7f6d5";
